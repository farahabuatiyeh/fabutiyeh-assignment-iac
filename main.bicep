...
@minLength(3)
@maxLength(30)
param appServiceAppName1 string = 'fabuatiyeh-assignment-prod-be'
@sys.description('The Web App name.')
@minLength(3)
@maxLength(30)
param appServiceAppName3 string = 'fabuatiyeh-assignment-prod-fe'
@sys.description('The App Service Plan name.')
@minLength(3)
@maxLength(30)
param appServicePlanName1 string = 'fabuatiyeh-assignment-prod'
@sys.description('The Web App name.')
@minLength(3)
@maxLength(30)
param appServiceAppName2 string = 'fabuatiyeh-assignment-dev-be'
@minLength(3)
@maxLength(30)
param appServiceAppName4 string = 'fabuatiyeh-assignment-dev-fe'
@sys.description('The App Service Plan name.')
@minLength(3)
@maxLength(30)
param appServicePlanName2 string = 'fabuatiyeh-assignment-dev'
@allowed([
  'nonprod'
  'prod'
  ])
...
module appService1 'modules/appthings.bicep' = if (environmentType == 'prod') {
  name: 'appService1'
  params: { 
    location: location
...
module appService3 'modules/appthingsFE.bicep' = if (environmentType == 'prod') {
  name: 'appService3'
  params: { 
    location: location
...
module appService2 'modules/appthings.bicep' = if (environmentType == 'nonprod') {
  name: 'appService2'
  params: { 
    location: location
...
module appService4 'modules/appthingsFE.bicep' = if (environmentType == 'nonprod') {
  name: 'appService4'
  params: { 
    location: location
